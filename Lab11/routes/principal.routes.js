...
function manejarPrincipal(request, response) {
    ...
    // Ruta 2 que muestra un mensaje
    if (request.url === "/acerca" && request.method === "GET") {
        response.setHeader('Content-Type', 'text/html');
        response.write(`
    ...
    // Ruta 3 que también muestra un mensaje
    if (request.url === "/json" && request.method === "GET") {
        response.setHeader('Content-Type', 'text/html');
        response.write(`
            <!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Ayuda</title>
    ...
    // Ruta 4 que igual muestra un mensaje
    if (request.url === "/saludo" && request.method === "GET") {
        response.setHeader('Content-Type', 'text/html');
        response.write(`
            <!DOCTYPE html><html lang="es"><head><meta charset="UTF-8"><title>Saludo</title>
...
//Las rutas de /procesar y /formulario están en el archivo formulario.routes.js

module.exports = manejarPrincipal;