...
const server = http.createServer((request, response) => {
    ...
    // Si la URL solicita el archivo CSS o JS
    else if (request.url === "/Lab08.css" || request.url === "/Lab08.js") {
    ...
    // Si la URL solicita el archivo CSS o JS
        ...
        response.write(`
            ...
            <body>
                <h1>Acerca de</h1>
                <p>Esta es una aplicación creada como parte del laboratorio.</p>
    ...
    } else if (request.url === '/formulario' && request.method === 'GET') {
        response.setHeader('Content-Type', 'text/html');
        response.write(`
            <!DOCTYPE html>
            <html lang="es">
    ...
    } else if (request.url === '/procesar' && request.method === 'POST') {
        let body = '';
